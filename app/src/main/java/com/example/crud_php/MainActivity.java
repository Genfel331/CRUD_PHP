...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                builder.setTitle(employeeArrayList.get(position).getNombre_Evento());
                    ...
                    public void onClick(DialogInterface dialog, int i) {
                        ...
                        switch (i){
                            ...
                            case 2:
                                ...
                                deleteData(employeeArrayList.get(position).getIdEvento());
    ...
    private void deleteData(final String IdEvento) {

        StringRequest request = new StringRequest(Request.Method.POST, "https://ticketonline.shop/Android/eliminar.php",
                        ...
                        try{
                            ...
                            if(exito.equals("1")){
                                ...
                                for(int i=0;i<jsonArray.length();i++){
                                    ...
                                    String Nombre_Evento = object.getString("Nombre_Evento");
                                    String Lugar = object.getString("Lugar");
                                    String Fecha = object.getString("Fecha");
                                    String Hora = object.getString("Hora");
                                    String IdAdmin = object.getString("IdAdmin");


                                    usuarios = new Usuarios(IdEvento,Nombre_Evento,Lugar,Fecha,Hora,IdAdmin);
